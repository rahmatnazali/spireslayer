...
- It will then try to decrypt the save data and convert it to an editable JSON format [like so](https://github.com/rahmatnazali/slay-the-spire-save-editor/blob/master/backups/2023-01-19%2007:13:11.270793.json).
